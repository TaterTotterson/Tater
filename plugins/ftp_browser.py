...
from helpers import send_waiting_message, load_image_from_url, redis_client
...
class FtpBrowserPlugin(ToolPlugin):
    ...
    async def handle_discord(self, message, args, ollama_client, context_length, max_response_length):
        ...
        await message.channel.send("Browsing `/`", view=FtpBrowserPlugin.FileBrowserView(self, user_id, "/", entries, ollama_client=ollama_client))
        return ""
