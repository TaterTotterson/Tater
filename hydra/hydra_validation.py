...
async def repair_tool_call_text(
    *,
    ...
    prompt = (
        ...
        "- If intent is ambiguous or conversational-only, return NO_TOOL only when no relevant executable tool/verba tool is available.\n"
        "- For actionable requests with a relevant verba/tool available, return a tool call instead of NO_TOOL.\n"
