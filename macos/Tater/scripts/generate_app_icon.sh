...
SOURCE_IMAGE="${RESOURCES_DIR}/TaterAvatar.png"
SOURCE_PREVIEW="${RESOURCES_DIR}/TaterIconSource.png"
ICONSET_DIR="${PROJECT_DIR}/build/TaterIcon.iconset"
OUTPUT_ICON="${RESOURCES_DIR}/TaterIcon.icns"
