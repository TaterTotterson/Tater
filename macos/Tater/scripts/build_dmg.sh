...
ditto "${APP_DIR}" "${STAGING_DIR}/Tater.app"
ln -s /Applications "${STAGING_DIR}/Applications"
cp "${BACKGROUND_IMAGE}" "${STAGING_DIR}/.background/TaterDmgBackground.png"
...
tell application "Finder"
  tell disk "${VOLUME_NAME}"
    ...
    set background picture of viewOptions to file ".background:TaterDmgBackground.png"
    set position of item "Tater.app" of container window to {420, 265}
