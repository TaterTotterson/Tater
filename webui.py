...
SYSTEM_PROMPT = (
    ...
    "6. 'watch_feed' for adding rss feeds to the watch list when the user asks and give you a rss link.\n\n"
    "7. 'unwatch_feed' for removing an RSS feed from the rss feed watch list.\n\n"
    "8. 'list_feeds' for listing watched RSS feeds from the rss feed watch list.\n\n"
