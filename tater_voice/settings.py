...
def voice_ui_setting_specs() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        {
            "key": "VOICE_NOISE_SUPPRESSION_ENABLED",
            "label": "Noise Suppression",
            "type": "checkbox",
            "default": vp.DEFAULT_NOISE_SUPPRESSION_ENABLED,
            "description": "Apply Tater-side mic cleanup before STT. VAD still uses the raw gained audio.",
        },
        {
            "key": "VOICE_NOISE_SUPPRESSION_HIGH_PASS_ENABLED",
            "label": "High-Pass Cleanup",
            "type": "checkbox",
            "default": vp.DEFAULT_NOISE_SUPPRESSION_HIGH_PASS_ENABLED,
            "description": "Remove DC offset and low-frequency rumble from satellite audio before STT.",
        },
        {
            "key": "VOICE_NOISE_SUPPRESSION_TAIL_SILENCE_S",
            "label": "Tail Silence Start (sec)",
            "type": "number",
            "default": vp.DEFAULT_NOISE_SUPPRESSION_TAIL_SILENCE_S,
            "min": 0.0,
            "max": 2.0,
            "step": 0.05,
            "description": "How much detected silence after speech must pass before Tater attenuates the STT tail.",
        },
        {
            "key": "VOICE_NOISE_SUPPRESSION_SILENCE_ATTENUATION",
            "label": "Tail Attenuation",
            "type": "number",
            "default": vp.DEFAULT_NOISE_SUPPRESSION_SILENCE_ATTENUATION,
            "min": 0.0,
            "max": 1.0,
            "step": 0.05,
            "description": "Gain applied to post-speech silence before STT. Lower values suppress noisy tails more strongly.",
        },
        {
...
def settings_sections() -> List[Dict[str, Any]]:
    runtime_groups = [
        ...
        (
            ...
            [
                "VOICE_INPUT_GAIN",
                "VOICE_NOISE_SUPPRESSION_ENABLED",
                "VOICE_NOISE_SUPPRESSION_HIGH_PASS_ENABLED",
...
def settings_item_form() -> Dict[str, Any]:
    return {
        ...
        "reset_confirm": "Restore native voice settings to defaults?",
