...
DEFAULT_OPENWAKEWORD_PATIENCE = 1
DEFAULT_OPENWAKEWORD_DEBOUNCE_S = 2.0
DEFAULT_OPENWAKEWORD_VAD_THRESHOLD = 0.0
DEFAULT_OPENWAKEWORD_DEVICE = "auto"
DEFAULT_OPENWAKEWORD_DIAGNOSTIC_LOGGING = True
DEFAULT_OPENWAKEWORD_STREAM_QUEUE_MAX = 12
DEFAULT_OPENWAKEWORD_DROP_QUEUED_FRAMES = True
...
def settings_snapshot() -> Dict[str, Any]:
    ...
    return {
        ...
        "stream_queue_max": _as_int(
            _setting("stream_queue_max", DEFAULT_OPENWAKEWORD_STREAM_QUEUE_MAX),
            DEFAULT_OPENWAKEWORD_STREAM_QUEUE_MAX,
            minimum=1,
            maximum=120,
        ),
        "drop_queued_frames": _as_bool(
            _setting("drop_queued_frames", DEFAULT_OPENWAKEWORD_DROP_QUEUED_FRAMES),
            DEFAULT_OPENWAKEWORD_DROP_QUEUED_FRAMES,
        ),
    }
